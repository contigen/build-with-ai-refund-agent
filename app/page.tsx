    ...
    <div className='flex flex-col min-h-screen bg-white text-zinc-900 font-sans selection:bg-zinc-100'>
      ...
      <header className='flex items-center justify-between px-6 py-4 border-b border-transparent sticky top-0 bg-white/80 backdrop-blur-md z-50'>
        ...
        <div className='hidden flex-1 max-w-md mx-8 md:flex relative group'>
          <Search
            size={16}
            className='absolute left-3 top-1/2 -translate-y-1/2 text-zinc-400 group-focus-within:text-zinc-600 transition-colors'
          />
          <input
            type='text'
        ...
        <section className='w-full max-w-4xl mx-auto px-6 pt-24 pb-16 flex flex-col items-center text-center'>
          ...
          <div className='flex flex-col items-center gap-3 w-full max-w-xl'>
            <p className='text-sm text-zinc-500 max-w-md'>
              A demonstration of autonomous refund handling, receipt validation,
              and on-chain payouts via the Arc Testnet.
            </p>
          </div>
        </section>
        ...
        <section className='w-full max-w-4xl mx-auto px-6'>
          <div className='flex items-center justify-between mb-6 pb-2 border-b border-zinc-100'>
            ...
            <div className='flex items-center gap-2 text-sm text-zinc-500'>
              <span className='bg-zinc-100 px-2 py-1 rounded-md text-xs font-medium text-zinc-700'>
                Enterprise
              </span>
            </div>
          </div>
              ...
              <div className='flex items-start justify-between gap-4'>
                <div className='space-y-3'>
                  ...
                  <p className='text-[15px] text-zinc-600 leading-relaxed max-w-3xl'>
                    Deploy a conversational AI agent that handles your return
                    pipeline end-to-end. Our system resolves customer requests
                    instantly without human intervention.
                  </p>

                  <div className='flex flex-wrap items-center gap-2 pt-1'>
                    <span className='px-2 py-0.5 rounded-md bg-blue-50 text-blue-600 text-xs font-mono font-medium'>
                      conversational-ai
                    </span>
                    <span className='px-2 py-0.5 rounded-md bg-zinc-100 text-zinc-600 text-xs font-mono font-medium'>
                  ...
                  <div className='flex items-center gap-6 text-xs text-zinc-500 pt-2 font-medium'>
                    <span className='flex items-center gap-1.5'>
                      <Download size={14} /> 2.1M Requests Handled
                    </span>
                    <span className='flex items-center gap-1.5'>
                      <Terminal size={14} /> API Ready
                    </span>
                  </div>
                </div>
                ...
                <Link
                  href='/chat'
                  className='hidden md:flex opacity-0 group-hover:opacity-100 shrink-0 bg-white border border-zinc-200 hover:border-zinc-300 text-zinc-700 font-medium text-sm px-4 py-2 rounded-lg items-center gap-2 transition-all shadow-sm'
                >
                  Test Chat Demo
                </Link>
              </div>
            ...
            <div className='py-8 group'>
              <div className='flex items-start justify-between gap-4'>
                <div className='space-y-3'>
                  ...
                  <p className='text-[15px] text-zinc-600 leading-relaxed max-w-3xl'>
                    Settle refunds globally in seconds using stablecoins.
                    Provide full transparency to customers by issuing refunds
                    directly on the Arc Testnet.
                  </p>

                  <div className='flex flex-wrap items-center gap-2 pt-1'>
                    <span className='px-2 py-0.5 rounded-md bg-emerald-50 text-emerald-600 text-xs font-mono font-medium'>
                      arc-testnet
                    </span>
                    <span className='px-2 py-0.5 rounded-md bg-emerald-50 text-emerald-600 text-xs font-mono font-medium'>
                      usdc
                  ...
                  <div className='flex items-center gap-6 text-xs text-zinc-500 pt-2 font-medium'>
                    ...
                    <span className='flex items-center gap-1.5'>
                      <Settings size={14} /> Real-time Settlement
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className='py-8 group'>
              <div className='flex items-start justify-between gap-4'>
                <div className='space-y-3'>
                  ...
                  <p className='text-[15px] text-zinc-600 leading-relaxed max-w-3xl'>
                    AI-driven receipt scanning and automated verification
                    against your store's return policy to prevent fraud and
                    ensure compliance.
                  </p>

                  <div className='flex flex-wrap items-center gap-2 pt-1'>
                    <span className='px-2 py-0.5 rounded-md bg-purple-50 text-purple-600 text-xs font-mono font-medium'>
                      fraud-prevention
                    </span>
                    <span className='px-2 py-0.5 rounded-md bg-purple-50 text-purple-600 text-xs font-mono font-medium'>
                      vision-models
                  ...
                  <div className='flex items-center gap-6 text-xs text-zinc-500 pt-2 font-medium'>
                    <span className='flex items-center gap-1.5'>
                      <Settings size={14} /> Custom Policies Supported
                    </span>
                  </div>
                </div>
              </div>
